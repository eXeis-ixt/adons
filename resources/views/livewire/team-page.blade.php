		...
		<div class="row justify-content-center">
			<div class="col-12">
				<div class="section-title text-center">
					...
					<p class="mb-0">The talent behind our company</p>
				</div>
			</div>
		</div>
			...
			<div class="col-xl-3 col-lg-4 col-md-6 mt-4">
				<div class="card bg-transparent border-0 text-center">
					<div class="card-img">
                       ...
                       @else
                       <img loading="lazy" decoding="async" src="https://hancockogundiyapartners.com/wp-content/uploads/2019/07/dummy-profile-pic-300x300.jpg" alt="Scarlet Pena" class="rounded w-100" width="300" height="332">

                       @endif

                       @if ($team->fb !='' || $team->tw !='' || $team->in !='')
                       <ul class="card-social list-inline">


                            @if ($team->fb !='')

							<li class="list-inline-item"><a target="_blank" class="facebook" href="https://facebook.com/{{$team->fb}}"><i class="fab fa-facebook"></i></a>
							</li>
                            @endif
                            @if ($team->tw !='')

							<li class="list-inline-item"><a target="_blank" class="twitter" href="https://x.com/{{$team->tw}}"><i class="fab fa-twitter"></i></a>
							</li>
                            @endif

                            @if ($team->in !='')
							<li class="list-inline-item"><a target="_blank" class="instagram" href="https://instagram.com/{{$team->in}}"><i class="fab fa-instagram"></i></a>
							</li>

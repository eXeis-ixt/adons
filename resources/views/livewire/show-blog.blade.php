...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta property="og:title" content="{{$blog->title}} | Adons" />
    ...
    @livewireStyles()
        ...
        <title> {{$blog->title}} | {{ $title ?? 'Adons' }}</title>
    </head>
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-8 mx-auto text-center">
                        {{-- <h2 class="mb-3 text-capitalize" style="">{{$blog->title}}</h2> --}}
                        <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                            <li class="list-inline-item"><a wire:navigate href="{{route('home')}}">Home</a>
                            </li>
                            <li class="list-inline-item">/ &nbsp; <a wire:navigate href="{{route('blog')}}">Blog</a>
                            </li>
                            <li class="list-inline-item">/ &nbsp; <a wire:navigate href="{{route('blog')}}">{{$blog->title}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="has-shapes" style="background: url({{asset('storage/',$blog->image)}})">
                ...
                <div class="col-lg-10">
                    <div class="mb-5 text-center">
                        <div class="post-slider rounded overflow-hidden">
                            @if ($blog->image != '')
                            <img  decoding="async" src="{{asset('storage/'.$blog->image)}}" width="100%" alt="Post Thumbnail">
                                @else
                  ...
                  <div class="mb-5">
                    ...
                    <p class="list-inline-item">Author : <a  class="ml-1">{{$blog->author}} </a>
                        @else
                    <p class="list-inline-item">Author : <a  class="ml-1"> Adons </a>
